"""
signal_design_jarred.py - Project script (example).
...
Paths (relative to repo root)
    ...
    INPUT FILE: data/system_metrics_jarred.csv
    OUTPUT FILE: artifacts/signals_jarred.csv

Terminal command to run this file from the root project folder

    uv run python -m cintel.signal_design_jarred
...
DATA_FILE: Final[Path] = DATA_DIR / "system_metrics_jarred.csv"
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "signals_jarred.csv"
...
def main() -> None:
    ...
    # ----------------------------------------------------
    # STEP 2.2: DEFINE THE ERROR RATE CALCULATION *CHANGED*
    # ----------------------------------------------------
    # This creates an expression for:
    #     errors / requests
    # It is only a calculation recipe at this point.
    # Modified to multiply by 100 to convert to percentage.
    calculated_error_rate: pl.Expr = (pl.col("errors") / pl.col("requests")) * 100
